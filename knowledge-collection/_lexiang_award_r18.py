# -*- coding: utf-8 -*-
"""乐享同步 . 颁奖 十八轮（2026-08-18·b 同名二次轮次）。
直连 streamable-http 客户端。仅新建当轮独立页 award-20260818b.html -> 子文件夹 f585d1b7（award）。
...
RUN_NAME = "award-20260818b.html"
RUN_PATH = os.path.join(KC, "award", RUN_NAME)
...
def main():
    try:
        ...
        sm["folder_id"] = FOLDER
        sm["rounds"].append({"date": "20260818", "entry_id": rid, "name": RUN_NAME})
