# -*- coding: utf-8 -*-
"""Award R22 (二十二轮, 2026-08-22) · 乐享文件上传（新建独立页），回写 lexiang-entry-map.json。"""
...
try:
    ...
    sm["folder_id"] = FOLDER
    sm["rounds"].append({"date":"2026-08-22","entry_id": rid, "name": RUN_NAME, "note":"轮次页 R22 (+6：职工技术创新成果奖政府SOP/一线服务之星表彰/青年岗位能手团中央办法/省长质量奖一把手亲颁/认可ROI测算框架/多元包容DEI表彰)"})
