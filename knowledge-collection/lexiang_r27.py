# -*- coding: utf-8 -*-
# Lexiang probe + upload for Open Day r27 (non-fatal; skip on any failure)
...
RUN  = os.path.join(KC, "openday", "runs", "openday-20260826-r27.html")
