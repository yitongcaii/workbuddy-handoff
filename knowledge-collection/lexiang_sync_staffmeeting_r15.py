...
(b) 新建当轮独立页 staff-meeting-2026-08-15-r15.html -> 子文件夹 a753a4eb
...
def main():
    ...
    # (b) 新建当轮独立页
    run_path = os.path.join(KC, "staff-meeting", "runs", "staff-meeting-2026-08-15-r15.html")
    run_data = open(run_path, "rb").read()
    run_name = "staff-meeting-2026-08-15-r15.html"
